...
// if(count($pdata)==0)
// {
//   redirect('http://brolance.com/phase2/signin.php');
// }
?>
<!DOCTYPE html>
<html manifest="index.hyperesources/cache.manifest">
  ...
  <style>
    @font-face {
        src:url('index.hyperesources/futuratot-bol-webfont.ttf') format('truetype')
    }
</style>
  <script type="text/javascript" src="index.hyperesources/jquery-2.1.3.js"></script>
  <script type="text/javascript" src="index.hyperesources/ilso.js"></script>
  ...
  <div id="index_hype_container" style="margin:auto;position:relative;width:1280px;height:720px;overflow:hidden;" aria-live="polite">
    <div  style="margin-top: 5%;">
      <img src="index.hyperesources/loading.gif" >
      
    </div>
     <script type="text/javascript" charset="utf-8" src="index.hyperesources/index_hype_generated_script.js?31916"></script>
  </div>
  ...
  <div style="display:none">
    ...
    <div></div>
    <div>Please check teacher Id and student Id</div>
    <div>Teacher Id
</div>
    <div>Student Id</div>
    <div></div>
