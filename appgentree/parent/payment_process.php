...
/*
   ******************************************************************************
* File Name        : payment_process.php                                                     
* File Description : using this file we transfer payment using paypal                                                               
* Author           : SimSam                                                              
******************************************************************************
*/
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if ($paymentStatus == "SUCCESS"){
        ...
        $date_validity = date('m-d-Y', strtotime("+7 days"));
        $date = date('m-d-Y');

        $data_user = array(
        "user_activation_key" => substr($user_id,0,8),
        ...
        <div dir="ltr" style="border:1px solid #f0f0f0;max-width:650px;font-family:Arial,sans-serif;color:#000000;margin:0 auto;">
            ...
            <div style="margin:30px 30px 30px 30px;line-height:21px">
                ...
                <br>
                <!-- <div style="font-size:14px;color:#333">
                    <a href="'.SITE_URL.'login/">LOG IN at GenTree Discover</a>
                </div>
                <br> -->
                <div style="font-size:14px;color:#333">
