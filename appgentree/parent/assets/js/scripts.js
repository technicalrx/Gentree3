 ...
 **************************************************************** **/
	function _misc() {
		...
		/** Isotope Portfolio
		 *********************** **/
		var portfolio_isotope_container = jQuery("#portfolio1.portfolio-isotope");
		...
		if(portfolio_isotope_container.length > 0) {
			loadScript(plugin_path + 'isotope/isotope.pkgd.min.js', function() {
				...
				if(jQuery().isotope) {
					...
					var _container = jQuery('#portfolio1');
					...
					function _recalcW() {
						...
						if(_container.hasClass('fullwidth')) { // Fullwidth 
							...
							if(_dw < 480) {
								_wItem = jQuery("#portfolio1").width();
							}

							// Apply item width
							jQuery("#portfolio1>.portfolio-item").css({"width":_wItem});

						} else { // Non Fullwidth 

							_mR		= parseInt(jQuery("#portfolio1>.portfolio-item").css('margin-right'));
							_w 		= jQuery("#portfolio1").closest('.container').width();
							_wItem 	= _w / _cols - _mR;
							...
							// Apply item & container width
							jQuery("#portfolio1.portfolio-isotope").css({"width":_w});
							jQuery("#portfolio1>.portfolio-item").css({"width":_wItem});
					...
					jQuery(window).load(function(){
						...
						var _t = setTimeout(function(){ 
							...
							jQuery('#portfolio1_filter>li>a').bind("click", function(e){
								e.preventDefault();

								jQuery('#portfolio1_filter>li.active').removeClass('active');
								jQuery(this).parent('li').addClass('active');
