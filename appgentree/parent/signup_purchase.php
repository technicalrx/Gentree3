<?php 
  /*******************************************************************************
* File Name        : signup_purchase.php                                                     
* File Description : Payment_summary.                                                               
* Author           : SimSam                                                              
*******************************************************************************/
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    }else
                    {
                    	...
                    	$("#redeem_amount").html(''+parseFloat(amount).toFixed(2));
                    	$("#divLoading").removeClass('show');
			...
			<section class="register-content">
				...
				<div id="divLoading"> 
					...
					<div class="row">
						<!-- left side steps -->
						<div class="col-md-3">
							<h3 class="color-white">Step 2 of 4</h3>
						</div>
							<!-- right side form -->
						<div class="col-md-9">
							<div class="bigwhitebox">
								...
								<div class="">
									...
									<h2 class="color-blue">Purchase Summary</h2>
										...
										<div class="row">
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="row">
													<div class="col-md-4 col-sm-4 col-xs-12">
														<div class="row">
															<div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-15">
																<strong>Product:</strong>&nbsp;&nbsp;&nbsp;Child Assessment
															</div>
													...
													<div class="col-md-8 col-sm-8 col-xs-12">
														<div class="row">
															<div class="col-md-5 col-sm-5 col-xs-4 margin-bottom-15"><strong>Quantity:</strong></div>
															<div class="col-md-7 col-sm-7 col-xs-8 margin-bottom-15"><?=count($childcount)?></div>
														</div>
													</div>
												</div>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="row">
													...
													<div class="col-md-8 col-sm-8 col-xs-12">
														<div class="row">
															<div class="col-md-5 col-sm-5 col-xs-4 margin-bottom-15"><strong>Price:</strong></div>
															<div class="col-md-7 col-sm-7 col-xs-8 margin-bottom-15">
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="row">
													...
													<div class="col-md-8 col-sm-8 col-xs-12 margin-bottom-15">
														<div class="row">
															<div class="col-md-5 col-sm-5 col-xs-4"><strong>Total:</strong></div>
															<div class="col-md-7 col-sm-7 col-xs-8" >$ <span id="total_amount"><?=number_format($amount,2)?></span></div>
														</div>
													</div>
												</div>
											</div>
													...
													<div class="col-md-8 col-sm-8 col-xs-12 margin-bottom-15">
														<div class="row">
															...
															<div class="col-md-7 col-sm-7 col-xs-8">
																<input class="small-size-with-screen" type="text" class="" id="promotion_code" name="promotion_code" placeholder="Enter Code">
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="row">
													<div class="col-md-4 col-sm-4 col-xs-12"></div>
													<div class="col-md-8 col-sm-8 col-xs-12 margin-bottom-15" id="coderedeem">
														<div class="row">
															<div class="col-md-5 col-sm-5 col-xs-4">
										...
										<form  id="purchase_form" action="/step2/?userid=<?=$_GET['userid']?>"   method="POST" >
